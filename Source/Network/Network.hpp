...
public:
    ...
    enum {
        ...
        LOG_NET_MESSAGE_GAME_PACKET_PLAYER_MOVING = 1,
        LOG_NET_MESSAGE_GAME_PACKET_PLAYER_MOVING_CLEAR_SPAM = 2,
    };
    ...
    std::string PLAYER_MOVING_STRING(int type) {
        switch (type) {
            ...
            case 40:  return "PACKET_PVE_UNK1";
            case 41:  return "PACKET_PVE_UNK2";
            case 42:  return "PACKET_PVE_UNK3";
            case 43:  return "PACKET_PVE_UNK4";
            case 44:  return "PACKET_PVE_UNK5";
            case 45:  return "PACKET_SET_EXTRA_MODS";
            case 46:  return "PACKET_ON_STEP_ON_TILE_MOD";
            case 47:  return "PACKET_MAXVAL";
